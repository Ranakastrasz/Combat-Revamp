...
data.raw.gun["combat-shotgun"].attack_parameters.movement_slow_down_factor = 0.3 -- 0.7
...
data.raw.gun["submachine-gun"].attack_parameters.movement_slow_down_factor = 0.5 -- 0.7
...
data.raw.gun["shotgun"].attack_parameters.movement_slow_down_factor = 0.3 -- 0.6
...
data.raw.gun["rocket-launcher"].attack_parameters.movement_slow_down_factor = 0.6 -- 0.8
